...
| Dokument | Innehåll |
|----------|----------|
| [ATGARDPLAN.md](./ATGARDPLAN.md) | **Aktuell** åtgärdsplan för Kallsurf Home |
| [../ux/BESLUT.md](../ux/BESLUT.md) | UX- och designbeslut |
| [../ux/VINDSKALA.md](../ux/VINDSKALA.md) | Sjustegsskala (`src/config/windScale.ts`) |
...
| [PLAN-NU-STAPELGRAF.md](./PLAN-NU-STAPELGRAF.md) | NU-stapeldiagram i Läget — ✅ implementerad (60 min obs + 30 min prognos) |
