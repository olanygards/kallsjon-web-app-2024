...
**Prognoshorisont:** data hämtas **72 timmar** framåt (`ACTIVE_FORECAST_HOURS`). Trendgrafen på Läget visar **senaste 6 h + kommande 12 h**; `DailyForecast` visar kommande dagar utifrån timbuckets.
